...
namespace RestfulRecovery
{
    ...
    internal static class RestBlocks
    {
        ...
        // space), no extra yaw. Y offsets approximate the seat cushion
        // surface; the seated pose keeps the hips near the entity origin.

        // Chairs: seat at the block center.
        private static readonly SeatProfile ChairProfile =
            new SeatProfile(new Vector3(0f, 0.42f, 0f), 0f);
        ...
        private static readonly SeatProfile CouchProfile =
            new SeatProfile(new Vector3(0f, 0.38f, 0.15f), 0f);
